  ...
  shouldProcessComment(username, reviewBody, commentType = 'comment', options = {}) {
    ...
    if (options.skipNits && nitCheck.isNit) {
      return { 
        ...
        details: { ...parsed, isNit: true, nitPattern: nitCheck.pattern }
      };
    }
    ...
    return { 
      ...
      details: { ...parsed, isNit: nitCheck.isNit, nitPattern: nitCheck.pattern }
    };
  }
}
