  ...
  try {
    ...
    const debugInfo = {
      ...
      reviewDetails: reviews.map(r => ({
        ...
        author: r.author,
        hasBody: !!r.body,
        bodyPreview: r.body ? r.body.substring(0, 100) + '...' : '(no body)',
        state: r.state,
        ...
        // Flag reviews that would have been skipped by old filtering logic
        wouldBeSkippedByOldLogic: !r.body && r.state !== 'COMMENTED'
      }))
    };
